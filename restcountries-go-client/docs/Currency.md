...
------------ | ------------- | ------------- | -------------
**Code** | Pointer to **string** | ISO 4217 code. Verified lookup path (currencies.code). | [optional] 
**Name** | Pointer to **string** | x-unverified key name. | [optional] 
**Symbol** | Pointer to **string** | x-unverified key name. | [optional] 
